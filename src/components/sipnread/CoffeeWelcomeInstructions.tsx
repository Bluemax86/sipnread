...
const instructionsData: Record<string, InstructionSet> = {
  ...
  coffee: {
    ...
    steps: [
      "Brew your favorite coffee, a plunger coffee works great or a Turkish coffee for best results. Avoid using a pod coffee machine.",
      "Enjoy your coffee, leaving a very small amount of liquid (about a teaspoon) at the bottom of the cup. A cup with agnled sidewalls works best",
      "Hold the cup in your dominant hand. Gently swirl the cup three times anticlockwise, ensuring good coverage around the cup.",
      "Carefully invert the cup onto a saucer/plate. Let it drain for about a minute. Do not lift it during this time.",
